...
public class ExControllerAdvice {
    ...
    public ApiResponse<ApiResponse.FailureBody> MemberValidateExHandler(MemberValidateException exception) {
        logger(exception);
        String defaultMessage = exception.getMessage();
    ...
    public ApiResponse<ApiResponse.FailureBody> TokenValidateExHandler(TokenValidateException exception) {
        logger(exception);
        String defaultMessage = exception.getMessage();
        return ApiResponseGenerator.fail(HttpStatus.BAD_REQUEST, exception.getCode(),
